...
class QuizController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('message','Tạo bài kiểm tra thành công');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('quiz.index'))->with('message','Update thành công');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('quiz.index'))->with('message','Delete thành công');
    }
