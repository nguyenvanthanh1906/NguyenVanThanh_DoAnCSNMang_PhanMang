...
Route::post('/quiz/getquestions','ExamController@getQuestions')->middleware('auth');

Route::get('/quiz/getquestion/{quizId}','ExamController@getQuizQuestions')->middleware('auth');
