            ...
            <div class="module">
                ...
                <div class="module_body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea type="text" name='description' class='span8' placeholder='description' >{{$quiz->description}}</textarea>
                            @error('description')
                            <div class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </div>
                        ...
                        <div class="controls">
                            <input type="text" name='minutes' class='span8' placeholder='time of a quiz' value="{{$quiz->minutes}}">
                            @error('minutes')
                            <div class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </div>
                        ...
                        <div class="controls">
                            <input type="text" name='paging' class='span8' placeholder='questions per page' value="{{$quiz->paging}}">
                            @error('paging')
                            <div class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </div>
